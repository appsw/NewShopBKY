...
@ActivityScope
public class UpChuFangModel extends BaseModel<ServiceManager, CacheManager> implements UpChuFangContract.Model {
    private Gson mGson;
    private Application mApplication;

    @Inject
    public UpChuFangModel(ServiceManager serviceManager, CacheManager cacheManager, Gson gson, Application application) {
