...
@ActivityScope
public class CommentModel extends BaseModel<ServiceManager, CacheManager> implements CommentContract.Model {
    private Gson mGson;
    private Application mApplication;

    @Inject
    public CommentModel(ServiceManager serviceManager, CacheManager cacheManager, Gson gson, Application application) {
