...
@ActivityScope
public class CarModel extends BaseModel<ServiceManager, CacheManager> implements CarContract.Model {
    private Gson mGson;
    private Application mApplication;

    @Inject
    public CarModel(ServiceManager serviceManager, CacheManager cacheManager, Gson gson, Application application) {
