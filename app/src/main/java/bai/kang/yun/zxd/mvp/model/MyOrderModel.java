...
@ActivityScope
public class MyOrderModel extends BaseModel<ServiceManager, CacheManager> implements MyOrderContract.Model {
    private Gson mGson;
    private Application mApplication;

    @Inject
    public MyOrderModel(ServiceManager serviceManager, CacheManager cacheManager, Gson gson, Application application) {
