...
@ActivityScope
public class FindModel extends BaseModel<ServiceManager, CacheManager> implements FindContract.Model {
    private Gson mGson;
    private Application mApplication;

    @Inject
    public FindModel(ServiceManager serviceManager, CacheManager cacheManager, Gson gson, Application application) {
